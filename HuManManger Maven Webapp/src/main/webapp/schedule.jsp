					...
					<div class="modal-body">
						<form class="form-horizontal" role="form" id="file1">
							<div class="form-group">
								<label for="rolesName" class="col-sm-2 control-label">部门名称:</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								...
								<select id="roleFind" class="form-control" name="rolesId"></select>
								</div>
							</div>
...
<script>
         ...
         var ary = data.list;
          ...
          name="全日班"
            ...
            var tr="<tr>";
                 ...
                 tr+="<td id='role'>"+obj.rolesName+"</td>";
  ...
  $(document).on("click",".aa",function(){
   ...
   var rolesName=$(this).parent().parent().find("#role").html();
   var staffName=$(this).parent().parent().find("#staff").html();
    ...
    $.ajax({
			       ...
			       $.ajax({
				        ...
				        success:function(data){
				         for(var i=0;i<data.length;i++){
				         if(rolesName==data[i].rolesName){
				         $("#roleFind").append("<option value='"+data[i].rolesId+"' selected='selected'>"+data[i].rolesName+"</option>");
				        	}else{
				        		$("#roleFind").append("<option value='"+data[i].rolesId+"'>"+data[i].rolesName+"</option>");
				        	} 
				        }
				        }
			      });
