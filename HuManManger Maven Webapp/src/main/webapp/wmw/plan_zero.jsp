...
<body>
   <ul class="nav nav-tabs">
     <li class="active"><a href="/HuManManger/wmw/plan_zero.jsp">待审批招聘计划</a></li>
...
<p></p>
	...
	<!-- 详细信息 模态框-->
   <div class="modal fade" id="zero_modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        	...
        	success : function(data) {
        		$("#plan_status").html("");
        		 for(var i=0; i<data.length;i++){
        		    ...
        		    tr+="<td>待审批</td>";
        		    tr+="<td><input type='button' id='"+data[i].PLAN_NO+"' value='详细信息' href='#zero_modal' data-toggle='modal'  class='details btn btn-primary'>"+
        		    "<input type='button' id='"+data[i].PLAN_NO+"' value='审批' href='#approval_modal' data-toggle='modal'  class='approval btn btn-primary'></td>"; 
        		    tr+="</tr>";
