...
<body>
   <ul class="nav nav-tabs">
     ...
     <li ><a href="/HuManManger/wmw/plan_one.jsp">已批准招聘计划</a></li>
     <li class="active"><a href="/HuManManger/wmw/plan_two.jsp">未批准招聘计划</a></li>
    </ul>
    <!-- 状态 -->
<!-- 招聘计划查询 -->
...
<!-- 详细信息 模态框-->
   <div class="modal fade" id="two_modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" style="width:700px">
	 ...
	 <div class="modal-dialog" style="width:700px">
        ...
        <div class="modal-footer">
             <button type="button" class="btn btn-primary"data-dismiss="modal" onclick="statusUpdate(1)">批准</button>
		</div>
		</div>
      </div>
   </div>
...
function querytwo(){
        	...
        	success : function(data) {
        		$("#plan_status").html("");
        		 for(var i=0; i<data.length;i++){
        		    ...
        		    tr+="<td>未批准</td>";
        		    tr+="<td><input type='button' id='"+data[i].PLAN_NO+"' value='详细信息' href='#two_modal' data-toggle='modal'  class='details btn btn-primary'>"+
        		    "<input type='button' id='"+data[i].PLAN_NO+"' value='批准' href='#approval_modal' data-toggle='modal'  class='approval btn btn-primary'></td>"; 
        		    tr+="</tr>";
	...
	$(function(){
					...
					data:JSON.stringify(planNo),
                 	...
                 	success : function(data) {
                           ...
                           var tr="<tr >";
        		            ...
        		            tr+="</tr>";
        		            tr+="<tr>";
        		            tr+="<td>审批人：</td><td>"+data[0].uname+"</td><td>审批时间：</td><td>暂未审批</td>";
        		            tr+="</tr>";
        		            tr+="<tr>";
        		            tr+="<td>审批意见：</td><td>"+data[0].APPROVE_COMMENT+"</td>";
        		            tr+="</tr>";
        		            $("#two_details").append(tr); 
						}
					});
				})
			})
	 ...
	 /* 招聘渠道 */
	 function ditch(PLAN_DITCH){
  	   if(PLAN_DITCH==""){
  	       return '无';
  	   }else if(PLAN_DITCH==1){
  	       return '网络招聘';
  	   }else if(PLAN_DITCH==2){
  	       return '招聘会招聘';
  	   }else if(PLAN_DITCH==3){
  	       return '人才猎头推荐';
  	   }
  	}
</script>
