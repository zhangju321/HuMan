...
public class attend_config {
    ...
    private Date duty_time1;

    private Date duty_time2;

    private Date duty_time3;

    private Date duty_time4;
	...
	public Date getDuty_time1() {
		return duty_time1;
	}

	public void setDuty_time1(Date duty_time1) {
		this.duty_time1 = duty_time1;
	}

	public Date getDuty_time2() {
		return duty_time2;
	}

	public void setDuty_time2(Date duty_time2) {
		this.duty_time2 = duty_time2;
	}

	public Date getDuty_time3() {
		return duty_time3;
	}

	public void setDuty_time3(Date duty_time3) {
		this.duty_time3 = duty_time3;
	}

	public Date getDuty_time4() {
		return duty_time4;
	}

	public void setDuty_time4(Date duty_time4) {
